export const books = [
  {
    ...
    // image: "/images/Book Images/1.svg",
  },
  {
    id: 2,
    ...
    for: "If you’re ready to leave your cushy employee life behind and build a business and a life you believe in, reading this essential guidebook is your first step to making it happen. ",
    aboutAuthor:
  ...
  },
  {
    ...
    for: "A must-read for people who want to learn how best to succeed.",
    aboutAuthor:
      "Trey Gowdy is a former state and federal prosecutor who experienced the criminal justice system firsthand for nearly two decades. In 2010, he was elected to Congress and was chair of the House Committee on Oversight and Government Reform and chaired the Select Committee on Benghazi.",
  },
  {
    id: 4,
    ...
    for: "This book relates to all of us, her readers, as fellow human beings.",
    aboutAuthor:
      "Amanda Little is a professor of journalism and Writer-in-Residence at Vanderbilt University. Her reporting on energy, technology, and the environment has taken her to ultra-deep oil rigs, down manholes, and inside monsoon clouds. Little’s work has appeared in publications ranging from The New York Times and The Washington Post to Wired, ",
  },
  {
    id: 5,
    title: "Lives of the Stoics",
    subtitle: "The Art of Living from Zeno to Marcus Aurelius",
    ...
    for: "A treasure of valuable insights and stories, this book can be visited again and again by any reader in search of inspiration from the past.",
    aboutAuthor:
  ...
  },
  {
    ...
    for: "If you feel trapped by a business you used to love, this book is for you",
    aboutAuthor:
  ...
  },
  {
    ...
    for: "Dehumanising technology, unimaginative city planning and austerity have made us unhappy, unhealthy and hostile. This book is a crucial call to arms: in the wake of the pandemic, Hertz argues, governments have an opportunity to rebuild along better lines.",
    aboutAuthor:
      "Amanda Little is a professor of journalism and Writer-in-Residence at Vanderbilt University. Her reporting on energy, technology, and the environment has taken her to ultra-deep oil rigs, down manholes, and inside monsoon clouds. Little’s work has appeared in publications ranging from The New York Times and The Washington Post to Wired, ",
  },
  {
    title: "Eat Better, Feel Better",
    subtitle: "My Recipes for Wellness and Healing, Inside and Out ",
    ...
    for: "If you are someone looking to reset your digestive system thanks to some changes in diet and how you prepare your food, Eat Better, Feel Better is a must read",
    aboutAuthor:
  ...
  },
  {
    ...
    title: "Dropshipping",
    author: "James Moore",
    subtitle: "How to Make Money Online and Build Your Own Online Business ",
    time: 12,
    reads: "",
    status: "pending",
    trending: false,
    ...
    audio: false,
    synopsis:
      "The Dropshipping Book is a handy, straightforward guide to setting up a successful e-commerce business with minimal overhead and investment. It provides a comprehensive overview of how an online retail business works and its benefits.",
    for: "Dropshipping By James Moore is not for everyone. You find Dropshipping interesting if you are: a novice business person interested in getting into online retail, an ambitious entrepreneur keen to cultivate passive income, curious about operating an online business.",
    aboutAuthor:
  ...
  },
  {
    id: 10,
    title: "Being Boss",
    subtitle: "Take Control of Your Work and Live Life on Your Own Terms",
    ...
    for: " If you see the letters CEO or BOSS or MANAGER in your future, this book is for you",
    aboutAuthor:
      "Along with co-authoring Being Boss, the book, Kathleen Shannon is the co-host of the popular podcast Being Boss: A Podcast for Creative Entrepreneurs where she's interviewed brilliant thought-leaders including Dr. Brené Brown, Marie Forleo, Chris Guillebeau, Ramit Sethi, Danielle LaPorte, Melissa Hartwig and more.",
  },
  {
    id: 11,
    ...
    for: "A must read for every entrepreneur, young or old, with a little or a big business. Essential knowledge for which you do not need a Phd to understand it. The original Preface, in which the whole book is summarized in one little drawing, moved in this new edition to the final chapter of the book.",
    aboutAuthor:
